...
\begin{table}[H]
\centering
\renewcommand{\arraystretch}{4} % Adjust row height (default is 1.0)
\resizebox{\textwidth}{!}{
\LARGE
...
\begin{tabular}{|l|l|l|l|l|l|l|}
\hline
\textbf{Technology} & \textbf{Learning Curve} & \textbf{Component Ecosystem} & \textbf{Performance} & \textbf{Dashboard Templates} & \textbf{Real-time Updates} & \textbf{Enterprise Adoption} \\ \hline
React.js & Moderate & Extensive (Recharts, React Flow, MUI) & Good (Virtual DOM) & Many available & Excellent with hooks & Very High \\ \hline
Vue.js & Easy & Good but smaller & Good & Some available & Good & Growing \\ \hline
Angular & Steep & Good (comprehensive) & Good & Some available & Good & High \\ \hline
Svelte & Easy & Limited & Excellent & Few available & Good & Low \\ \hline
\end{tabular}
}

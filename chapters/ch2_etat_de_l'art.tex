...
\begin{figure}[H]
    \centering
    \includegraphics[width=5cm]{images/react.png}
    \caption{React Logo}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=5cm]{images/reactflow.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=5cm]{images/recharts.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=5cm]{images/material.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=5cm]{images/pydantic.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=5cm]{images/Docker.png}
    \caption{Docker Logo}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=6cm]{images/Kubernetes.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=5cm]{images/Gitlab.png}
    \caption{GitLab Logo}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=5cm]{images/prometheus.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{images/logical_archi.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{images/physical_archi.pdf}
